    ...
    <div className="bg-gray py-[50px] border-t border-green-300">
      <div className="container grid lg:grid-cols-[65%_35%] gap-5">
        <div>
          ...
          <h2 className="text-[57px] leading-[65px] text-black bebas font-bold my-5">
            Who is Foysal Ahmed ?
          </h2>
          ...
          <p className="text-lg text-[#333] mb-2">
            ...
            organic YouTube promotion. My expertise includes{" "}
            <span className="font-semibold">
              Technical SEO, On-Page SEO, Keyword Research, YouTube SEO,
