...
import { ChevronDown, Menu, RocketIcon, X } from "lucide-react";
...
function Header() {
  ...
  return (
    <header className="w-full font-sans">
      {/* --- Top Bar (Dark Green) --- */}
      <div className="bg-[#1C4B42] text-white py-1 flex justify-center items-center gap-2 text-xs md:text-sm font-bold">
        <SiRocket size={16} />
        <span>Top Rated Plus SEO Expert</span>
      </div>

      {/* --- Middle Info Bar (Lime Green) - Hidden on Mobile --- */}
      <div className="hidden lg:flex bg-[#92C200] text-white px-10 pt-2 pb-3 justify-between items-center text-sm poppins">
      ...
      {/* --- Main Navigation --- */}
      <nav className="bg-gray px-4 py-3 lg:px-10 flex justify-between items-center relative poppins">
        {/* Logo Placeholder */}
