...
const seoPillars = [
  {
    ...
    tagline: "Crawlers don't guess. They read.",
    desc: "Optimizing your site's architecture, cleaning semantic DOM trees, eliminating code bloat, and setting up pristine site mapping so search engines index your pages flawlessly.",
    icon: FaNetworkWired,
    metrics: [
      { label: "Core Web Vitals", value: "99/100" },
      { label: "Index Readiness", value: "100%" },
    ],
    checks: [
      "Clean Document Object Model (DOM)",
      "Automated XML Sitemapping",
  ...
  },
  {
    ...
    tagline: "Milliseconds cost conversions.",
    desc: "Compressing complex structural media, fine-tuning server response behaviors, forcing next-gen image extensions, and creating near-instant local navigation load weights.",
    icon: FaBolt,
    metrics: [
      { label: "Time to Interactive", value: "0.4s" },
      { label: "TTFB Improvement", value: "-62%" },
    ],
    checks: [
      "Next-Gen Image Formats (WebP/AVIF)",
      "Edge Caching Integration",
      "CSS/JS Minification Trees",
    ],
  },
  {
    id: "authority",
    title: "Intent & Content Tuning",
    tagline: "Rank for conversion intent, not just traffic.",
    desc: "Structuring content headers and keyword semantic layout hierarchies. We align your layout hierarchy directly with search intent patterns to steal competitor visibility.",
    icon: FaSearchDollar,
    metrics: [
      { label: "Organic Reach Visibility", value: "+140%" },
      { label: "CTR Bounce Mitigation", value: "-22%" },
    ],
    checks: [
      "Semantic Heading Architecture",
      "Intent Clustering Optimization",
      "Schema Data Structuring",
    ],
  },
];

const WebsiteSeoPage = () => {
  const [activeTab, setActiveTab] = useState("technical");
  const activeData = seoPillars.find((p) => p.id === activeTab);
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
          ...
          <div className="max-w-3xl mb-16 space-y-4">
            ...
            <p className="text-gray-600 text-lg">
              SEO isn't a checklist; it's algorithmic architecture. I clean,
              restructure, and accelerate codebases to turn search visibility
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-8 bg-white border border-gray-200 shadow-xl shadow-gray-200/50 rounded-[32px] p-6 md:p-10 min-h-[480px] relative flex flex-col justify-between">
              {/* Top Row: Simulated SEO Audit Header */}
              ...
              <div className="mt-8 pt-6 border-t border-gray-100 flex flex-wrap items-center justify-between text-xs text-gray-400 font-mono gap-4">
                <div className="flex items-center gap-2">
                  ...
                  <span>Search indexing metrics mapped automatically.</span>
                </div>
