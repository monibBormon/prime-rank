          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
            ...
            <div className="max-w-3xl mb-16 space-y-4">
              ...
              <p className="text-gray-600 text-lg">
                Google Ads isn't about bidding higher; it's about bidding
                smarter. I design, optimize, and scale campaigns that turn
                targeted searches into immediate, predictable revenue.
              </p>
            </div>
